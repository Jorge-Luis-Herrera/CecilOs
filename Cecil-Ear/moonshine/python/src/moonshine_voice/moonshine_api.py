...
class _MoonshineLib:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            try:
                print(f"DEBUG: Initializing _MoonshineLib instance")
                cls._instance._load_library()
            except Exception as e:
                print(f"DEBUG: Failed to initialize _MoonshineLib: {e}")
                cls._instance = None
                raise
    ...
    def _load_library(self):
        ...
        if lib_path is None:
            ...
            print(f"DEBUG: Library not found in specific paths, trying system paths: {lib_name}")
            lib_path = lib_name
